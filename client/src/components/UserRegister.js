      ...
      <div className='col-lg-7 col-10 mx-auto'>
        ...
        <Form className='mb-5'>
          <Form.Group className='mb-3' controlId='firstName'>
            ...
            <Form.Control type='firstName' name='firstName' />
          </Form.Group>
        ...
        <div className='d-flex justify-content-end'>
          <div>Already have an account? <Nav.Link as={Link} to={"/login"} className={"d-sm-inline text-primary fw-bold"}>Log In</Nav.Link></div>
        </div>
      </div>
    </div>
  )
